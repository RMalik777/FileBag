  ...
  return (
    <>
      ...
      <div className="h-screen">
            <div className="flex">
            <select id="category" name="category" defaultValue="category" className="bg-3 font-bold text-white w-36 h-10 text-center mb-6">
            ...
            <div className="flex flex-row justify-between mx-">
                ...
                <form>
                    <input type="text" placeholder="Search" className="bg-3 text-white" />
